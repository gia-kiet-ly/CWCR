...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260315133352_Fix_CollectionRequest_UniqueIndex_SoftDelete")]
    partial class Fix_CollectionRequest_UniqueIndex_SoftDelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.CollectionRequest", b =>
                {
                    ...
                    b.HasIndex("WasteReportWasteId", "EnterpriseId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domain.Entities.EnterpriseWasteCapability", b =>
                {
                    ...
                    b.Property<decimal>("AssignedTodayKg")
            ...
            modelBuilder.Entity("Domain.Entities.WasteReport", b =>
                {
                    ...
                    b.Property<bool>("IsPointCalculated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<DateTime?>("PointCalculatedAt")
                        .HasColumnType("datetime2");

                    b.Property<int>("RedispatchCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.DisputeResolution", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ApplicationUser", "Enterprise")
                        .WithMany()
                        .HasForeignKey("EnterpriseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
